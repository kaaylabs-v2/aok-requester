                ...
                return (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton
                      ...
                      isActive={active}
                      tooltip={item.title}
                      className={active ? "bg-[#f43f7a] text-white shadow-[0_8px_20px_-8px_rgba(244,63,122,0.55)] ring-1 ring-white/20 hover:bg-[#f43f7a] hover:text-white data-[active=true]:bg-[#f43f7a] data-[active=true]:text-white" : ""}
                    >
